...
class ReportController extends Controller
{
    ...
    public function addComment(Request $request, $id)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'user_name' => $user->name,
                'user_avatar' => avatar_url($user->avatar),
    ...
    private function formatReport($report, bool $includeComments = false): array
    {
        ...
        $data = [
            ...
            'reporter_avatar' => avatar_url($report->user?->avatar),
        ...
        if ($includeComments) {
            ...
            $allComments = $report->comments?->map(fn($comment) => [
                ...
                'user_avatar' => avatar_url($comment->user?->avatar),
    ...
    public function confirmers(Request $request, string $id)
    {
        ...
        $confirmers = $report->confirmations()
            ...
            ->map(fn($c) => [
                ...
                'user_avatar' => avatar_url($c->user->avatar ?? null),
                'note' => $c->note,
