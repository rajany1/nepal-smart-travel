    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto p-6">
        ...
        <form method="POST" action="{{ route('admin.travel-partners.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div><label class="block text-xs font-semibold text-slate-600 mb-1">NPR Value (Rs.)</label><input type="number" name="value_npr" step="0.01" value="0" class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm"></div>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto p-6">
        ...
        <form method="POST" id="editForm" class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div><label>NPR Value (Rs.)</label><input type="number" name="value_npr" id="editValueNpr" step="0.01" value="0" class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm"></div>
            </div>
