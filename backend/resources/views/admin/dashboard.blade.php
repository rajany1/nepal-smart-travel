        ...
        <div class="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                ...
                <div class="inline-flex items-center gap-2 rounded-3xl bg-slate-100 px-4 py-3 text-sm text-slate-600">
                    <span class="h-8 w-8 rounded-2xl bg-primary-600 text-white grid place-items-center"><i class="fas fa-rocket"></i></span>
            ...
            <div class="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                    ...
                    <span class="rounded-full bg-primary-100 px-3 py-1 text-sm font-semibold text-primary-700">7-day trend</span>
                </div>
                <div class="mt-5">
        ...
        <div class="space-y-6">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <span class="rounded-3xl bg-primary-100 px-3 py-2 text-sm font-semibold text-primary-700">Live</span>
                </div>
    ...
    <div class="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between gap-4 border-b border-slate-200 pb-4">
                ...
                <a href="{{ route('admin.reports') }}" class="text-sm font-semibold text-primary-600 hover:text-primary-800">View all</a>
            </div>
                        ...
                        <div class="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-primary-600 text-white">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
                                    <div>
                                        <p class="font-semibold text-slate-900">{{ $user->name }}</p>
                                        <p class="text-xs text-slate-500">{{ $user->email }}</p>
                                    </div>
                                </div>
                                <span class="rounded-full bg-primary-100 px-3 py-1 text-xs font-semibold text-primary-700">{{ ucfirst($user->roleName ?? 'user') }}</span>
                            </div>
                        </div>
                    @empty
